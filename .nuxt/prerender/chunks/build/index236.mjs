import { findSingle, isTouchDevice, relativePosition, getOuterWidth, absolutePosition, getFocusableElements, addStyle, focus, find, getLastFocusableElement, getFirstFocusableElement } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/@primeuix/utils/dom/index.mjs';
...
import { s as script$2 } from './index6.mjs';
import script$5 from './index2110.mjs';
import { O as OverlayEventBus } from './index17.mjs';
import { s as script$4 } from './index18.mjs';
import { R as Ripple } from './index8.mjs';
import script$6 from './index250.mjs';
import { s as script$7 } from './index10.mjs';
import { style } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/@primeuix/styles/treeselect/index.mjs';
import { B as BaseStyle } from './server.mjs';
import { resolveComponent, createElementBlock, openBlock, mergeProps, createElementVNode, renderSlot, createCommentVNode, createVNode, Fragment, createTextVNode, toDisplayString, renderList, normalizeClass, createBlock, resolveDynamicComponent, withCtx, Transition, withModifiers, createSlots } from 'file:///Users/kimlarocca/Websites/dearest-jack/node_modules/vue/index.mjs';
import './index7.mjs';
import './index5.mjs';
    ...
    label: function label() {
      ...
      if (value.length) {
        if (isNotEmpty(this.maxSelectedLabels) && value.length > this.maxSelectedLabels) {
          label2 = this.getSelectedItemsLabel();
        } else {
          label2 = value.map(function(node) {
            return node.label;
          }).join(", ");
        }
      } else {
